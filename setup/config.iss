...
Source: "..\bin\Release\GpuIcon.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: gpu
; NOTE: Don't use "Flags: ignoreversion" on any shared system files

[Components]
Name: "battery"; Description: "Battery Icon"; Types: all
Name: "cpu"; Description: "Cpu Icon"; Types: all non_battery
Name: "gpu"; Description: "Gpu Icon"; Types: all non_battery
...
Name: "{group}\GpuIcon"; Filename: "{app}\GpuIcon.exe"; WorkingDir: "{app}"; IconFilename: "{app}\GpuIcon.exe"; IconIndex: 0; Components: gpu
...
Name: "{userstartup}\GpuIcon"; Filename: "{app}\GpuIcon.exe"; WorkingDir: "{app}"; IconFilename: "{app}\GpuIcon.exe"; IconIndex: 0; Components: gpu; Tasks: startup_gpu
...
Name: "startup_gpu"; Description: "Gpu Icon"; GroupDescription: "Autostart on login"; Components: gpu
...
Filename: "{app}\GpuIcon.exe"; WorkingDir: "{app}"; Flags: nowait postinstall; Description: "run Gpu Icon"; Components: gpu
